...
const BOAT_SPEED = 2.25; // Tăng từ 2.25 (Tốc độ qua trái/phải bằng phím)
let INITIAL_SCROLL_SPEED = 2.0; // Tăng từ 1.0
const SPEED_INCREMENT = 0.0002; // Tăng từ 0.0001
let MAX_SCROLL_SPEED = 5.0; // Tăng từ 2.5
...
function startGameWithLevel(level) {
    ...
    // Cấu hình theo Level
    if (level === 1 || level === 2) {
        INITIAL_SCROLL_SPEED = 1.8; // Tăng từ 0.9
        MAX_SCROLL_SPEED = 4.5; // Tăng từ 2.25
    } else {
        INITIAL_SCROLL_SPEED = 2.0; // Tăng từ 1.0
        MAX_SCROLL_SPEED = 5.0; // Tăng từ 2.5
    }
